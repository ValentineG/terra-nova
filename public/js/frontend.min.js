...
"use strict";
    ...
    constructor() {
    super(...arguments), this.documents= {
}
, this.initDocumentClasses(), this.attachDocumentsClasses();
}
getDefaultSettings() {
    return {
    selectors:  {
...
attachDocumentClass(e) {
    const t=e.data(), n=t.elementorId, s=t.elementorType, o=this.documentClasses[s]||this.documentClasses.base;
    ...
    var s=n(3203), o=s(n(6397)), i=s(n(8704)), r=s(n(4985)), l=s(n(7537)), a=s(n(355)), d=s(n(2804)), c=s(n(3384));
...
, this.runReadyTrigger=function(t) {
    ...
    const s=jQuery(t), o=s.attr("data-element_type");
    if(o&&(elementorFrontend.hooks.doAction("frontend/element_ready/global", s, e), elementorFrontend.hooks.doAction(`frontend/element_ready/$ {
    o;
}
`, s, e), "widget"===o)) {
...
`, s, e);
    ...
    var s=n(3203);
    n(59);
    var o=s(n(9220)), i=s(n(5107)), r=s(n(3308)), l=s(n(1604)), a=s(n(1911)), d=s(n(4773)), c=s(n(2064)), u=s(n(8628)), h=s(n(8646)), m=s(n(6866)), g=s(n(4375)), p=s(n(6404)), f=s(n(6046)), v=s(n(1322)), b=s(n(5670)), y=n(6028);
    const _=n(9469), k=n(9804), w=n(3346);
...
getDefaultSettings() {
    return {
    selectors:  {
    elementor: ".elementor", adminBar:"#wpadminbar"}
}}getDefaultElements() {
    const e= {
...
getGeneralSettings(e) {
    return this.isEditMode()&&parent.elementorDevTools.deprecation.deprecated("getGeneralSettings()", "3.0.0", "getKitSettings() and remove the `elementor_` prefix"), this.getKitSettings(`elementor_$ {
    e;
}
`);
}getKitSettings(e) {
...
initOnReadyComponents() {
    this.utils= {
    youtube: new l.default, vimeo:new a.default, baseVideoLoader:new d.default, get lightbox() {
    return h.default.getLightbox();
}
, urlActions: new c.default, swiper:u.default, environment:r.default, assetsLoader:new m.default, escapeHTML:y.escapeHTML, events:p.default, controls:new v.default;
    ...
    StretchElement: elementorModules.frontend.tools.StretchElement, Masonry:elementorModules.utils.Masonry;
}
...
, this.addUserAgentClasses(), this.setDeviceModeData(), this.initDialogsManager(), this.isEditMode()&&this.muteMigrationTraces(), p.default.dispatch(this.elements.$window, "elementor/frontend/init"), this.initModules(), this.initOnReadyElements(), this.initOnReadyComponents();
}
onDocumentLoaded() {
...
`, swiperWrapper: "swiper-wrapper", swiperSlide:"elementor-background-slideshow__slide swiper-slide", swiperPreloader:"swiper-lazy-preloader", slideBackground:"elementor-background-slideshow__slide__image", kenBurns:"elementor-ken-burns", kenBurnsActive:"elementor-ken-burns--active", kenBurnsIn:"elementor-ken-burns--in", kenBurnsOut:"elementor-ken-burns--out"}}}getSwiperOptions() {
    const e=this.getElementSettings(), t= {
    grabCursor: !1, slidesPerView:1, slidesPerGroup:1, loop:"yes"===e.background_slideshow_loop, speed:e.background_slideshow_transition_duration, autoplay: {
    delay: e.background_slideshow_slide_duration, stopOnLastSlide:!e.background_slideshow_loop;
}
, handleElementorBreakpoints:!0, on: {
    slideChange: ()=> {
    ...
    case"fade": t.effect="fade", t.fadeEffect= {
    crossFade: !0;
}
;
    break;
    case"slide_down": t.autoplay.reverseDirection=!0, t.direction="vertical";
    break;
    case"slide_up": t.direction="vertical"}
return"yes"===e.background_slideshow_lazyload&&(t.lazy= {
    loadPrevNext: !0, loadPrevNextAmount:1;
}
), t;
}buildSwiperElements() {
    const e=this.getSettings("classes"), t=this.getElementSettings(), n="slide_left"===t.background_slideshow_slide_transition?"ltr": "rtl", s=jQuery("<div>",  {
    class: e.swiperContainer, dir:n;
}
), o=jQuery("<div>",  {
    class: e.swiperWrapper;
}
), i=t.background_slideshow_ken_burns, r="yes"===t.background_slideshow_lazyload;
...
r&&(l+=" swiper-lazy"), this.elements.$slides=jQuery(), t.background_slideshow_gallery.forEach((t=> {
    ...
    s=jQuery("<div>",  {
    class: l, "data-background":t.url;
}
), s.append(n);
}else s=jQuery("<div>",  {
    class: l, style:'background-image: url("'+t.url+'");
    '}
);
...
onElementChange(e) {
    ...
    return {
    selectors:  {
    backgroundVideoContainer: ".elementor-background-video-container", backgroundVideoEmbed:".elementor-background-video-embed", backgroundVideoHosted:".elementor-background-video-hosted"}
}}getDefaultElements() {
...
calcVideosSize(e) {
    ...
    const n=this.elements.$backgroundVideoContainer.outerWidth(), s=this.elements.$backgroundVideoContainer.outerHeight(), o=t.split(": "), i=o[0]/o[1], r=n/s>i;
    return {
    width: r?n:s*i, height:r?n/i:s;
}
}changeVideoSize() {
...
startVideoLoop(e) {
    ...
    url: t, width:this.elements.$backgroundVideoContainer.outerWidth().width, autoplay:!0, loop:!n.background_play_once, transparent:!0, background:!0, muted:!0;
}
;
...
, onStateChange: t=> {
    switch(t.data) {
    case o: n.removeClass("elementor-invisible elementor-loading");
    break;
    case e.PlayerState.ENDED: "function"==typeof this.player.seekTo&&this.player.seekTo(s.background_video_start||0), s.background_play_once&&this.player.destroy();
}
}}, playerVars: {
...
activate() {
    ...
    const e=this.getElementSettings("background_video_start"), s=this.getElementSettings("background_video_end");
...
onElementChange(e) {
    ...
    var o=s(n(4058)), i=s(n(9501)), r=[o.default, i.default];
    t.default=r;
}
, 7537: (e, t, n)=> {
    var s=n(3203);
...
, svgURL:elementorFrontend.config.urls.assets+"shapes/"}}getDefaultElements() {
    const e= {
}
...
buildSVG(e) {
    const t="shape_divider_"+e, n=this.getElementSettings(t), s=this.elements["$"+e+"Container"];
...
getStretchActiveValue() {
    ...
    return {
    selectors:  {
    links: '.elementor-element a[href*="#"]', stickyElements:".elementor-element.elementor-sticky"}
}}onInit() {
    ...
    childList: !0, subtree:!0, attributes:!0, attributeFilter:["class", "style"];
}
);
...
trackAnchorLinks(e, t) {
    e.forEach((e=> {
    const n=this.getAnchorTarget(e), s=this.getScrollPosition(n);
    t.push( {
    element: n, type:"anchor", scrollPosition:s;
}
);
}));
...
=n;
    ...
    t.push( {
    scrollMarginTop: s, type:"sticky", scrollPosition:o;
}
);
}));
}organizeStickyAndAnchors(e) {
    const t=this.filterAndSortElementsByType(e, "sticky"), n=this.filterAndSortElementsByType(e, "anchor");
    t.forEach(((e, s)=> {
    ...
    return n&&(t.element.style.scrollMarginTop=`$ {
    e.scrollMarginTop;
}
px`), n;
}));
...
isExcludedHash(e) {
    const t=""===e, n=e.startsWith("#elementor-action");
    return t||n;
}
getAnchorTarget(e) {
    const t=e?.hash;
    return this.isExcludedHash(t)?null: this.isValidSelector(t)?document.querySelector(t):(console.warn(`Invalid selector: '$ {
    t;
}
'`), null);
    ...
    getDefaultSettings: ()=>( {
    scrollDuration: 500, selectors: {
    links: 'a[href*="#"]', targets:".elementor-element,  .elementor-menu-anchor", scrollable:(0, s.isScrollSnapActive)()?"body":"html,  body"}
}), getDefaultElements() {
    return {
...
if(t.length) {
    var i=t.offset().top, r=elementorFrontend.elements.$wpAdminBar, l=jQuery(".elementor-section.elementor-sticky--active: visible");
...
loadAsset(e, t) {
    ...
    const n=elementorFrontendConfig.urls.assets, s=elementorFrontendConfig.environmentMode.isScriptDebug?"": ".min", o=elementorFrontendConfig.version, i=elementorFrontendConfig.experimentalFeatures.e_swiper_latest?`$ {
    n;
}
lib/swiper/v8/swiper$ {
    s;
}
.js"share-link":  {
    src: `$ {
...
.js"head"}, "e-lightbox":  {
    ...
    elementorFrontendConfig.urls.uploadUrl;
}
/elementor/css/custom-lightbox.min.css"head", before: "#elementor-frontend-css"}}}}, 1322:(e, t)=> {
    Object.defineProperty(t, "__esModule",  {
    value: !0;
}
), t.default=void 0;
...
getResponsiveControlValue(e, t) {
    ...
    const s=(arguments.length>3&&void 0!==arguments[3]?arguments[3]: null)||elementorFrontend.getCurrentDeviceMode(), o=this.getControlValue(e, t, n);
    if("widescreen"===s) {
    const s=this.getControlValue(e, `$ {
    t;
}
_widescreen`, n);
    return s||0===s?s: o;
...
})), t=elementorFrontend.utils.assetsLoader.load("script", "dialog"), s=elementorFrontend.utils.assetsLoader.load("style", "dialog"), o=elementorFrontend.utils.assetsLoader.load("script", "share-link"), i=elementorFrontend.utils.assetsLoader.load("style", "swiper"), r=elementorFrontend.utils.assetsLoader.load("style", "e-lightbox");
    return Promise.all([e, t, s, o, i, r]).then((()=>e));
}
getDefaultSettings() {
    return {
    selectors:  {
    links: "a,  [data-elementor-lightbox]", slideshow:"[data-elementor-lightbox-slideshow]"}
}}getDefaultElements() {
    return {
    $links: jQuery(this.getSettings("selectors.links")), $slideshow:jQuery(this.getSettings("selectors.slideshow"));
}
}isLightboxLink(e) {
...
async onLinkClick(e) {
    const t=e.currentTarget, n=jQuery(e.target), s=elementorFrontend.isEditMode(), o=s&&elementor.$previewContents.find("body").hasClass("elementor-editor__ui-state__color-picker"), i=!!n.closest(".elementor-edit-area").length;
...
adjustConfig(e) {
    ...
    slidesPerView: e.slidesPerView, slidesPerGroup:e.slidesPerGroup?e.slidesPerGroup:1;
}
})), e;
}}}, 2064:(e, t, n)=> {
    Object.defineProperty(t, "__esModule",  {
...
;
    ...
    for(var i=arguments.length, r=new Array(i>1?i-1: 0), l=1;
    l<i;
    l++)r[l-1]=arguments[l];
    n(s, ...r);
}
...
runHashAction() {
    ...
    const e=document.querySelector(`[data-e-action-hash="$ {
    location.hash;
}
"],  a[href*="$ {
    location.hash;
...
createActionHash(e, t) {
    return encodeURIComponent(`#elementor-action: action=$ {
    e;
}
&settings=$ {
...
;
    e= {
    largeToSmall: !1, withDesktop:!1, ...e;
}
;
...
return s;
    ...
    class Events {
    static dispatch(e, t) {
    let n=arguments.length>2&&void 0!==arguments[2]?arguments[2]: null, s=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null;
...
;
    ...
    var i, r, l;
    if(n[e][t])if(s)if(i=n[e][t], o)for(l=i.length;
    l--;
...
function _addHook(e, t, s, o, i) {
    var r= {
    callback: s, priority:o, context:i;
}
, l=n[e][t];
    if(l) {
    var a=!1;
...
function _runHook(e, t, s) {
    ...
    if(i=r.length, "filters"===e)for(o=0;
    o<i;
    o++)s[0]=r[o].callback.apply(r[o].context, s);
    else for(o=0;
    o<i;
    o++)r[o].callback.apply(r[o].context, s);
...
, addAction: function addAction(t, n, s, o) {
    ...
    const matchUserAgent=e=>n.indexOf(e)>=0, n=navigator.userAgent, s=!!window.opr&&!!opr.addons||!!window.opera||matchUserAgent(" OPR/"), o=matchUserAgent("Firefox"), i=/^((?!chrome|android).)*safari/i.test(n)||/constructor/i.test(window.HTMLElement)||"[object SafariRemoteNotification]"===(!window.safari||"undefined"!=typeof safari&&safari.pushNotification).toString(), r=/Trident|MSIE/.test(n)&&!!document.documentMode, l=!r&&!!window.StyleMedia||matchUserAgent("Edg"), a=!!window.chrome&&matchUserAgent("Chrome")&&!(l||s), d=matchUserAgent("Chrome")&&!!window.CSS, c=matchUserAgent("AppleWebKit")&&!d;
    var u= {
    isTouchDevice: "ontouchstart"in window||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0, appleWebkit:c, blink:d, chrome:a, edge:l, firefox:o, ie:r, mac:matchUserAgent("Macintosh"), opera:s, safari:i, webkit:matchUserAgent("AppleWebKit");
}
;
    t.default=u;
}
...
, DataCloneError: {
    ...
    var s=n(1695), o=n(2086), i=n(563), r=n(5736), l=n(7826).f, a=n(9606), d=n(1855), c=n(5070), u=n(1879), h=n(3621), m=n(79), g=n(5283), p=n(3296), f="DOMException", v=i("Error"), b=i(f), y=function DOMException() {
    d(this, _);
    var e=arguments.length, t=u(e<1?void 0: arguments[0]), n=u(e<2?void 0:arguments[1], "Error"), s=new b(t, n), o=v(t);
    return o.name=f, l(s, "stack", r(1, m(o.stack, 1))), c(s, this, y), s;
}
, _=y.prototype=b.prototype, k="stack"in v(f), w="stack"in new b(1, 2), S=b&&g&&Object.getOwnPropertyDescriptor(o, f), E=!(!S||S.writable&&S.configurable), A=k&&!E&&!w;
    s( {
...
,  {
    ...
    var M=i(f), C=M.prototype;
    if(C.constructor!==M)for(var $ in p||l(C, "constructor", r(1, M)), h)if(a(h, $)) {
    var D=h[$], L=D.s;
    a(M, L)||l(M, L, r(6, D.c));
}
}}, e=> {
